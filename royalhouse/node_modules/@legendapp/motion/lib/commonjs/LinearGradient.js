...
class GradientHelper extends _react.Component {
  render() {
    const {
      numColors,
      startX,
...
const MotionLinearGradient = (0, _tools.MemoFnComponent)(function (props) {
  const {
    colors,
    animateProps,
    start,
  ...
  return /*#__PURE__*/_react.default.createElement(AnimatedGradientHelper, _extends({
    numColors: numColors
  }, propsOut, {
