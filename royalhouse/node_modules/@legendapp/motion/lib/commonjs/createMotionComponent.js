        ...
        if (!anims[key] || anims[key].value !== value) {
          ...
          if (typeof requestAnimationFrame !== 'undefined') {
            requestAnimationFrame(() => {
              const callback = onAnimationComplete ? () => onAnimationComplete(key) : undefined; // Spring or timing based on the transition prop

              if (transitionForKey.type === 'spring') {
                _reactNative.Animated.spring(anims[key].animValue, animOptions).start(callback);
              } else {
                _reactNative.Animated.timing(anims[key].animValue, animOptions).start(callback);
              }
            });
          }
        }
