...
const useTransformOrigin = function useTransformOrigin(transformOrigin, transform, onLayoutProp) {
  ...
  const everDidLayout = (0, _tools.useEverHadValue)(!!transformOrigin, true);
  ...
  if (everDidLayout) {
    ...
    onLayout = (0, _react.useCallback)(e => {
...
exports.useTransformOrigin = useTransformOrigin;
